...
\begin{figure}[h!]
  \centering
  \subfloat[][Gruppe]{\includegraphics[width=0.15\linewidth]{images/RettR_Gruppe.pdf}}
  \qquad
  \subfloat[][Trupp]{\includegraphics[width=0.15\linewidth]{images/RettR_Trupp.pdf}}
\end{figure}
